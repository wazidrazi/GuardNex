const StatsCard = ({
  ...
  return (
    <div className="bg-white overflow-hidden shadow rounded-lg h-full transition-all duration-300 hover:shadow-xl">
      ...
      {change ? (
        ...
        <div className="bg-gray-50 px-5 py-3 border-t border-gray-100">
          <div className="text-sm text-gray-500">No change data available</div>
        </div>
      )}
    </div>
  );
